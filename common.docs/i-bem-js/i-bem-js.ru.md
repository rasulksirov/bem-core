...
В соответствие с БЭМ-методологией состояния блока должны описываться модификаторами. По этому расширение функциональности блока, часто, предполагает реализацию поддержки новых модификаторов.
